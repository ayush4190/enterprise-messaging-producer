 ...
 * @hidden
 */
export declare function getAnalyticsData(config: UsageAnalyticsProjectConfig): Promise<AnalyticsData>;
export declare function getProjectIdentifier(config: UsageAnalyticsProjectConfig, packageJson: PackageJson): string;
/**
...
export {};
//# sourceMappingURL=analytics-data.d.ts.map
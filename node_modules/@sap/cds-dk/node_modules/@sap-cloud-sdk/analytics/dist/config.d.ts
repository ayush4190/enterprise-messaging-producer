 ...
 * @hidden
 */
export declare const configFileName = "sap-cloud-sdk-analytics.json";
/**
 ...
 * @hidden
 */
export declare function writeConfig(config: UsageAnalyticsProjectConfig, path?: string): void;
/**
 ...
 * @hidden
 */
export declare function findConfigPath(): string | undefined;
/**
 ...
 * @hidden
 */
export declare function generateConfig(path: string): void;
/**
 ...
 * @hidden
 */
export declare function enforceValidConfig(config: UsageAnalyticsProjectConfig): UsageAnalyticsProjectConfig;

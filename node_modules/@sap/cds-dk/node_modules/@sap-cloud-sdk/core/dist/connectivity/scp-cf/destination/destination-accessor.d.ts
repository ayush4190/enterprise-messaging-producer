...
import { Destination, DestinationNameAndJwt, DestinationRetrievalOptions } from './destination-service-types';
 ...
 */
export declare function useOrFetchDestination(destination: Destination | DestinationNameAndJwt, options?: DestinationOptions): Promise<Destination | null>;
 ...
 */
export declare function getDestinationOptions(name: string, options?: DestinationOptions): Promise<Destination | null>;
/**
 ...
 * @returns A promise returning the requested destination on success.
 */
export declare function getDestination(name: string, options?: DestinationOptions): Promise<Destination | null>;
//# sourceMappingURL=destination-accessor.d.ts.map
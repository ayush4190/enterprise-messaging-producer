...
function useOrFetchDestination(destination, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, destination_service_types_1.isDestinationNameAndJwt)(destination)
                    ? getDestination(destination.destinationName, destination.jwt ? __assign({ userJwt: destination.jwt }, options) : options)
...
function getDestination(name, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, ((0, destination_from_env_1.searchEnvVariablesForDestination)(name, options) ||
                    (0, destination_from_vcap_1.searchServiceBindingForDestination)(name) ||
                    (0, destination_from_service_1.getDestinationFromDestinationService)(name, options))];
        });
    });
}

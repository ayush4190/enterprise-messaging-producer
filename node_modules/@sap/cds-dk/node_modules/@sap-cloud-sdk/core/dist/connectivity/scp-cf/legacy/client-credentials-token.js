...
exports.getOAuth2ClientCredentialsToken = void 0;
 ...
 */
function getOAuth2ClientCredentialsToken(destination) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (!areValidCredentials(destination)) {
                throw new Error('The provided destination does not comply to "OAuth2ClientCredentials" authentication requirements. Check whether the destination includes the `tokenServiceUrl`, `clientId`, and `clientSecret` attributes.');
            }
            if (!destination.tokenServiceUrl) {
                throw new Error('The property `tokenServiceUrl` of the destination is undefined.');
            }
            return [2 /*return*/, (0, xsuaa_service_1.clientCredentialsGrant)(destination.tokenServiceUrl, getTokenServiceCredentials(destination), {}, {
...
exports.getOAuth2ClientCredentialsToken = getOAuth2ClientCredentialsToken;
function areValidCredentials(destination) {
    return !!(destination.tokenServiceUrl &&
        destination.clientId &&
        destination.clientSecret);
}
function getTokenServiceCredentials(destination) {
...
//# sourceMappingURL=client-credentials-token.js.map
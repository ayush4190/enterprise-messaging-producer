...
exports.addCsrfTokenAndCookies = void 0;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = [{}];
                    return [4 /*yield*/, (0, http_client_1.buildCsrfHeaders)(request.destination, {
                            headers: headers,
                            url: request.relativeServiceUrl()
                        })];
                case 1: return [2 /*return*/, __assign.apply(void 0, [__assign.apply(void 0, _a.concat([(_b.sent())])), headers])];
            }
        });
    });
}
exports.addCsrfTokenAndCookies = addCsrfTokenAndCookies;
//# sourceMappingURL=legacy-csrf-token-header.js.map
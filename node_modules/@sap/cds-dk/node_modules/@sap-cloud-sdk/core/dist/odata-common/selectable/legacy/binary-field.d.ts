 ...
 */
export declare class BinaryFieldBase<EntityT extends Entity, SelectableT extends boolean = false> extends EdmTypeField<EntityT, string, false, SelectableT> {
}
/**
 * @deprecated Since v1.47.0. Use [[EdmTypeField]] instead.
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class BinaryField<EntityT extends Entity> extends BinaryFieldBase<EntityT, true> {
}
/**
 * @deprecated Since v1.47.0. Use [[EdmTypeField]] instead.
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeBinaryPropertyField<EntityT extends Entity, ComplexT = any> extends BinaryFieldBase<EntityT> {
    /**
...
//# sourceMappingURL=binary-field.d.ts.map
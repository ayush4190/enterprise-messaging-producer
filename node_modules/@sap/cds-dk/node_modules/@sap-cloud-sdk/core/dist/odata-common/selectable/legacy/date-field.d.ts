 ...
 */
export declare class DateFieldBase<EntityT extends Entity, SelectableT extends boolean = false> extends EdmTypeField<EntityT, moment.Moment, false, SelectableT> {
    /**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class DateField<EntityT extends Entity> extends DateFieldBase<EntityT, true> {
}
/**
 * @deprecated Since v1.47.0. Use [[OrderableEdmTypeField]] instead.
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeDatePropertyField<EntityT extends Entity, ComplexT = any> extends DateFieldBase<EntityT> {
    /**

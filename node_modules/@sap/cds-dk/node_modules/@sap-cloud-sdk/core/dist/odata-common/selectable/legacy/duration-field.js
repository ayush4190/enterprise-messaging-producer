...
exports.ComplexTypeDurationPropertyField = exports.DurationField = exports.DurtionFieldBase = void 0;
 ...
 */
var DurtionFieldBase = /** @class */ (function (_super) {
    __extends(DurtionFieldBase, _super);
    function DurtionFieldBase() {
     ...
     */
    DurtionFieldBase.prototype.greaterThan = function (value) {
     ...
     * @returns The resulting filter
     */
    DurtionFieldBase.prototype.greaterOrEqual = function (value) {
     ...
     * @returns The resulting filter
     */
    DurtionFieldBase.prototype.lessThan = function (value) {
     ...
     * @returns The resulting filter
     */
    DurtionFieldBase.prototype.lessOrEqual = function (value) {
        return new filter_1.Filter(this.fieldPath(), 'le', value, this.edmType);
    };
    return DurtionFieldBase;
}(edm_type_field_1.EdmTypeField));
exports.DurtionFieldBase = DurtionFieldBase;
/**
 * @deprecated Since v1.47.0. Use [[OrderableEdmTypeField]] instead.
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
var ComplexTypeDurationPropertyField = /** @class */ (function (_super) {
    __extends(ComplexTypeDurationPropertyField, _super);
    /*
     * Union of the two possible constructors.
     */
    function ComplexTypeDurationPropertyField(fieldName, fieldOf, arg3, arg4) {
     ...
     */
    ComplexTypeDurationPropertyField.prototype.fieldPath = function () {
        return this.fieldOf instanceof complex_type_field_1.ComplexTypeField
            ? "".concat(this.fieldOf.fieldPath(), "/").concat(this._fieldName)
            : this._fieldName;
    };
    return ComplexTypeDurationPropertyField;
}(DurtionFieldBase));
exports.ComplexTypeDurationPropertyField = ComplexTypeDurationPropertyField;

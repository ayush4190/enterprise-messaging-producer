 ...
 */
export declare abstract class ComplexTypeField<EntityT extends Entity, ComplexT = any, NullableT extends boolean = false, SelectableT extends boolean = false> extends Field<EntityT, NullableT, SelectableT> {
     ...
     */
    constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT, ComplexT>, complexType: ComplexTypeNamespace<ComplexT>, fieldOptions?: FieldOptions<NullableT, SelectableT>);
    /**
 ...
 */
export declare function getEntityConstructor<EntityT extends Entity, ComplexT>(fieldOf: ConstructorOrField<EntityT, ComplexT>): Constructable<EntityT>;
/**

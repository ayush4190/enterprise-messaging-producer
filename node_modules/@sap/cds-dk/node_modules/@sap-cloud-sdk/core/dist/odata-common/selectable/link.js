...
var Link = /** @class */ (function () {
     ...
     */
    function Link(_fieldName, _entityConstructor, _linkedEntity) {
        this._fieldName = _fieldName;
        this._entityConstructor = _entityConstructor;
        this._linkedEntity = _linkedEntity;
        /**
    ...
    Link.clone = function (link) {
        var clonedLink = new Link(link._fieldName, link._entityConstructor, link._linkedEntity);
        clonedLink._selects = link._selects;
        return clonedLink;
    };
    Object.defineProperty(Link.prototype, "selects", {
        /**
    ...
    Link.prototype.clone = function () {
        var clonedLink = new this.constructor(this._fieldName, this._entityConstructor, this._linkedEntity);

 ...
 */
export declare class NumberFilterFunction<EntityT extends Entity> extends OrderableFilterFunction<EntityT, number> {
    /**
...
//# sourceMappingURL=number-filter-function.d.ts.map
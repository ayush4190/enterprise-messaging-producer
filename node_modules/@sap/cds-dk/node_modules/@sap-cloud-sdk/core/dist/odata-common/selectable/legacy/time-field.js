...
exports.ComplexTypeTimePropertyField = exports.TimeField = exports.TimeFieldBase = void 0;
 ...
 */
var TimeFieldBase = /** @class */ (function (_super) {
    __extends(TimeFieldBase, _super);
    function TimeFieldBase() {
     ...
     */
    TimeFieldBase.prototype.greaterThan = function (value) {
     ...
     * @returns The resulting filter
     */
    TimeFieldBase.prototype.greaterOrEqual = function (value) {
     ...
     * @returns The resulting filter
     */
    TimeFieldBase.prototype.lessThan = function (value) {
     ...
     * @returns The resulting filter
     */
    TimeFieldBase.prototype.lessOrEqual = function (value) {
        return new filter_1.Filter(this.fieldPath(), 'le', value, this.edmType);
    };
    return TimeFieldBase;
}(edm_type_field_1.EdmTypeField));
exports.TimeFieldBase = TimeFieldBase;
/**
 * @deprecated Since v1.47.0. Use [[OrderableEdmTypeField]] instead.
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
var ComplexTypeTimePropertyField = /** @class */ (function (_super) {
    __extends(ComplexTypeTimePropertyField, _super);
    /*
     * Union of the two possible constructors.
     */
    function ComplexTypeTimePropertyField(fieldName, fieldOf, arg3, arg4) {
     ...
     */
    ComplexTypeTimePropertyField.prototype.fieldPath = function () {
        return this.fieldOf instanceof complex_type_field_1.ComplexTypeField
            ? "".concat(this.fieldOf.fieldPath(), "/").concat(this._fieldName)
            : this._fieldName;
    };
    return ComplexTypeTimePropertyField;
}(TimeFieldBase));
exports.ComplexTypeTimePropertyField = ComplexTypeTimePropertyField;

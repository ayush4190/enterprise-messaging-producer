 ...
 */
export declare class StringFilterFunction<EntityT extends Entity> extends FilterFunction<EntityT, string> {
    /**
...
//# sourceMappingURL=string-filter-function.d.ts.map
 ...
 */
declare type NullableFieldType<FieldT extends FieldType, NullableT extends boolean> = NullableT extends true ? FieldT | null : FieldT;
/**
 ...
 */
export declare type EdmTypeForEdmOrFieldType<EdmOrFieldT extends EdmTypeShared<'any'> | FieldType> = EdmOrFieldT extends EdmTypeShared<'any'> ? EdmOrFieldT : EdmTypeShared<'any'>;
/**
 ...
 */
export declare class EdmTypeField<EntityT extends Entity, EdmOrFieldT extends EdmTypeShared<'any'> | FieldType, NullableT extends boolean = false, SelectableT extends boolean = false> extends Field<EntityT, NullableT, SelectableT> {
     ...
     */
    constructor(fieldName: string, _fieldOf: ConstructorOrField<EntityT>, edmType: EdmTypeForEdmOrFieldType<EdmOrFieldT>, fieldOptions?: FieldOptions<NullableT, SelectableT>);
    /**
     * Creates an instance of Filter for this field and the given value using the operator 'eq', i.e. `==`.
     * @param value - Value to be used in the filter
     * @returns The resulting filter
     */
    equals(value: FieldTypeByEdmType<EdmOrFieldT, NullableT>): Filter<EntityT, FieldTypeByEdmType<EdmOrFieldT, NullableT>>;
    /**
     * Creates an instance of Filter for this field and the given value using the operator 'ne', i.e. `!=`.
     * @param value - Value to be used in the filter
     * @returns The resulting filter
     */
    notEquals(value: FieldTypeByEdmType<EdmOrFieldT, NullableT>): Filter<EntityT, FieldTypeByEdmType<EdmOrFieldT, NullableT>>;
    /**

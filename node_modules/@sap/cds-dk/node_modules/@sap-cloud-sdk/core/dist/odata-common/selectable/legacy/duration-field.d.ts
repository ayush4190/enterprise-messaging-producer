 ...
 */
export declare class DurtionFieldBase<EntityT extends Entity, SelectableT extends boolean = false> extends EdmTypeField<EntityT, moment.Duration, false, SelectableT> {
    /**
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class DurationField<EntityT extends Entity> extends DurtionFieldBase<EntityT, true> {
}
/**
 * @deprecated Since v1.47.0. Use [[OrderableEdmTypeField]] instead.
 ...
 * @typeparam EntityT - Type of the entity the field belongs to
 */
export declare class ComplexTypeDurationPropertyField<EntityT extends Entity, ComplexT = any> extends DurtionFieldBase<EntityT> {
    /**

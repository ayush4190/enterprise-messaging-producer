import { Entity as EntityBase, Constructable, ODataCreateRequestConfig as ODataCreateRequestConfigBase } from '../../odata-common';
/**
 * @deprecated Since v1.21.0. Use superclass instead.
 * OData create request configuration for an entity type.
 * @typeparam EntityT - Type of the entity to setup a request for
 */
declare class ODataCreateRequestConfig<EntityT extends EntityBase> extends ODataCreateRequestConfigBase<EntityT> {
    /**

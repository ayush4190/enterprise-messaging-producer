import { Entity as EntityBase, Constructable, ODataDeleteRequestConfig as ODataDeleteRequestConfigBase } from '../../odata-common';
/**
 * @deprecated Since v1.21.0. Use superclass instead.
 * OData delete request configuration for an entity type.
 * @typeparam EntityT - Type of the entity to setup a request for
 */
declare class ODataDeleteRequestConfig<EntityT extends EntityBase> extends ODataDeleteRequestConfigBase<EntityT> {
    /**

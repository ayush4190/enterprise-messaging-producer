import { Orderable } from '../../odata-common';
 ...
 */
export declare function getQueryParametersForOrderBy<EntityT extends Entity>(orderBy: Orderable<EntityT>[]): Partial<{
    orderby: string;
}>;
//# sourceMappingURL=get-orderby.d.ts.map
    ...
    ODataBatchRequestBuilder.prototype.execute = function (destination, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.executeRaw(destination, options)
                        .then(function (response) { return (0, batch_response_parser_1.parseBatchResponse)(response); })
                        .then(function (parsedResponse) {
                        return (0, batch_response_deserializer_1.deserializeBatchResponse)(parsedResponse, _this.entityToConstructorMap, response_data_accessor_1.responseDataAccessor, entity_deserializer_1.entityDeserializer);
                    })

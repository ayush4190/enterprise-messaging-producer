 ...
 */
export declare type ParametersType<ApiT, FnT extends keyof ApiT> = ApiT[FnT] extends (...args: any) => any ? Parameters<ApiT[FnT]> : never;
/**
 ...
 * @typeparam FnT - Name of the function, that is part of the API.
 */
export declare type FunctionReturnType<ApiT, FnT extends keyof ApiT> = ApiT[FnT] extends (...args: any) => any ? UnPromisify<ReturnType<ApiT[FnT]>> : never;
/**
 * Unwrap the Axios response type.
 */
export declare type UnwrapAxiosResponse<T> = T extends AxiosResponse<infer U> ? U : T;
/**
 ...
 */
export declare type UnPromisify<T> = T extends Promise<infer U> ? U : T;
/**

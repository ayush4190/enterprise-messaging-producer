 ...
 */
function finishAll(promises, errorMessage) {
    return __awaiter(this, void 0, void 0, function () {
        var settledPromises, rejectedPromises, reasons, message;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.allSettled(promises)];
                case 1:
                    settledPromises = _a.sent();
                    rejectedPromises = settledPromises.filter(function (promise) { return promise.status === 'rejected'; });
                    if (rejectedPromises.length) {
                        reasons = rejectedPromises
                            .map(function (promise) { return "\t".concat(promise.reason); })
                            .join('\n');
                        message = errorMessage ? "".concat(errorMessage, " ") : '';
                        throw new Error("".concat(message, "Errors: [\n").concat(reasons, "\n]"));
                    }
                    return [2 /*return*/];
            }
        });
